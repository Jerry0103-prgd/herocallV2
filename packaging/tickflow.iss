; ===========================================================================
; HERO CALL — Inno Setup 安装包脚本
; ===========================================================================
; 用途: 把 PyInstaller 产出的 dist/HeroCall/ 文件夹封装成
...
;   3. 产物: packaging\Output\HeroCall-Setup-x.x.x.exe
;
; 设计决策:
...
#define MyAppName          "HERO CALL"
#define MyAppNameEN       "HERO CALL"
#define MyAppExeName      "HeroCall.exe"
#define MyAppPublisher    "HERO CALL"
...
DefaultDirName=D:\HeroCall
DefaultGroupName={#MyAppName}
DisableProgramGroupPage=yes
OutputDir=Output
OutputBaseFilename=HeroCall-Setup-{#MyAppVersion}
...
Source: "..\backend\dist\HeroCall\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
begin
  ...
  begin
    DefaultDir := ExpandConstant('{localappdata}\Programs\HeroCall');
